...
To keep users' freedom of interrupt the service consumption
...
makes possible keep control of the time fraction of the service
...
steps: opening, transaction and closing; project's implementation
described below:
...
Before sending the initial value transaction (\textit{in proportion with
  the duration of the service}) user's front-end generates an ephemeral elliptic curve
